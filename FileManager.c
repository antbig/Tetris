...
/**
	...
	ParamËtres :
		...
		User_profil			=> Pointeur vers le profil cible vers lequel on transfËre les donnÈes dans le fichier de sauvegarde
**/
...
/**
	Pour rÈcupÈrer le fichier de high-score
	ParamËtre :
...
/**
	Pour rÈÈcrire le fichier de high-score
	ParamËtre :
